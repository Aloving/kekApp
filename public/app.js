    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var items = this.props.items.map(function (item) {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Item__["a" /* default */], { stat: _this2.props.stat, percent: _this2.props.stat ? Math.round(item.price / (summ / 80)) : '', number: Math.round(Math.random() * 4), price: item.price, title: item.title, key: _this2.props.id ? item._id : counter++ });
            });
...
var Item = function (_React$Component) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: this.props.stat ? 'item_percent item color_' + this.props.number + '' : ' item color_' + this.props.number + '' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'span',
                    { style: style,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_stat_svg__ = __webpack_require__(311);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_home_svg__ = __webpack_require__(310);
